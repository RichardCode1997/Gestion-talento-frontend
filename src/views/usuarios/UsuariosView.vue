        ...
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr v-for="u in usuariosFiltrados" :key="u.idUsuario">
              ...
              <td>
                <button
                  :class="['estado-toggle', u.estado ? 'activo' : 'inactivo']"
...
.data-table th {
  ...
  white-space: nowrap; border-bottom: 1px solid #f0f2f5;
}
.data-table td {
  padding: 12px 14px; border-bottom: 1px solid #f8f9fb; vertical-align: middle;
}
...
.user-avatar {
  ...
  background: linear-gradient(135deg, #4f8cff, #cc5de8);
